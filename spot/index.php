...
// data-toggle="modal" data-target="#sampleModal" id="images"
     
//data-toggle='modal' data-target='#imageModal' data-recipient='".h($image_name[$i])."'
...
/*        スポット画像モーダル*/
/*
        html body.modal-open div#sampleModal div.modal-dialog div.modal-content div#modal-images-list{
            height:85vh;
        }
...
<!--               <button class="btn btn-default" data-toggle="modal" data-target="#sampleModal" id="images">２枚の写真</button>-->
...
//            echo "\t\t<div class='list-rating-l pull-right hidden-xs'>\n";
...
//            echo "\t\t\t<span class='glyphicon glyphicon-star' aria-hidden='true'></span>\n";
//            echo "\t\t</div>\n";
//            echo "\t\t<div class='list-rating-s visible-xs-block'>\n";
//            echo "\t\t\t<span class='glyphicon glyphicon-star' aria-hidden='true'></span>\n";
//            echo "\t\t\t<span class='glyphicon glyphicon-star' aria-hidden='true'></span>\n";
//            echo "\t\t\t<span class='glyphicon glyphicon-star color' aria-hidden='true'></span>\n";
//            echo "\t\t\t<span class='glyphicon glyphicon-star color' aria-hidden='true'></span>\n";
