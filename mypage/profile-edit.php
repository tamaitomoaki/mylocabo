...
<form action="profile-edit_act.php" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <!--                <input type="text" class="form-control  input-lg" id="exampleInputEmail1" placeholder="Email" value="<?=h($_SESSION["name"])?>">-->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <div class="collapse" id="collapse-area">
                <div class="well">
    <!--                    <input type="text" class="form-control input-lg" id="stance" name="stance" placeholder="（例）飲食店">-->
