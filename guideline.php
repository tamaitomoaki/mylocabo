                    ...
                    <div id="wrapper">
                        <div class="site1column">
                            <article class="contentsA">
                                ...
                                <p>
                                    訪れたことのあるスポットの情報をご記載ください。<br /> ※上記の内容に抵触している投稿は運営側の判断により、投稿を削除させて頂く事がござますので予めご了承ください。
                                    <br />
                                </p>
                                <h3>2．事実確認のできない誹謗中傷や個人的なクレームは避けましょう</h3>
                                <p>
                                    根拠のない誹謗中傷はユーザーの混乱を招くことがあるため、事実確認のできない誹謗中傷の記載はお控えください。<br /> 個人的なクレームに関してもご遠慮ください。（投稿された口コミの内容が事実かどうかの確認は行っておりません。）
                                    <br /> ＊根拠のない断定的な表現はお控えください。
                                    <br /> ＊個人的なクレームや食品衛生法・衛星管理に関する内容の口コミはしかるべき当局へご連絡をお願いします。
                                    <br />
                                </p>
                                ...
                                <p>
                                    雑誌、書籍等から引用する場合は、引用部分と口コミ本文とを明確明確に区別するようにしてください。<br /> 他のサイトから引用する場合は、そのサイトの運営者に引用する許可を必ずとってください。
                                    <br /> 無断で引用した投稿に関しては当社では一切責任を負いませんので予めご了承ください。
                                    <br /> また、マイロカボ内で他のユーザー様の投稿を引用する事も同様です。
                                    <br />
                                </p>
                                <h3>8．店舗関係者によるやらせ等はやめましょう</h3>
                                <p>
                                    閲覧する方にとっての信頼を担保する為、店舗関係者の方の口コミ等はご遠慮ください。<br /> 少しでも気になる口コミがありましたら事実を確認し削除させていただく事もございますのでご了承ください。
                                    <br />
                                </p>
                                <h3>最後に・・・</h3>
                                <p>
                                    マイロカボでは健全な口コミと質を保つために<br /> 日々口コミを管理しチェックをさせていただいております。
                                    <br /> 本ガイドラインに抵触する口コミはユーザー様に断わりなく削除または、修正依頼をさせていただくことがございますので予めご了承ください。
                                    <br />
                                </p>
                            </article>
                        </div>
